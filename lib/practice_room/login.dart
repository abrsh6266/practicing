...
class _LoginPageState extends State<LoginPage> {
  ...
  bool _autoValidate = false; // For controlling auto validation
  ...
  void _loginUser() {
    if (_formStateKey.currentState!.validate()) {
      ...
      setState(() {
        _autoValidate = true; // Enable auto validation after first submit attempt
      });
    }
  }
                    ...
                    children: <Widget>[
                      TextFormField(
                        decoration: const InputDecoration(
                            hintText: "user@example.com", labelText: "Email"),
